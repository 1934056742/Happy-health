<template>
	<div class="resetpwd">	
      ...
      <div class="box">
			<div class="content">
				<input type="text" placeholder="请输入新密码"><br>
				<input type="text" placeholder="确认密码">
            <label>
               <input type="text" placeholder="验证码" class="three">
               <span class="yzm">验证码</span>
               <span class="change">换一张，看不清</span>
            </label>				
				<button>完成</button>
			</div>
		</div>
